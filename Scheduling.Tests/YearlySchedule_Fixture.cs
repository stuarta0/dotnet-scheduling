...
namespace Scheduling.Tests
{
    ...
    public class YearlySchedule_Fixture
    {
        ...
        public void Occurrences_before_start()
        {
            ...
            IList<DateTime> occurrences = year.GetOccurrences(_start, new DateTime(1900, 1, 1), new DateTime(1950, 1, 1)).ToList();
        ...
        public void Occurrences_before_start_boundry_case()
        {
            // 3/11/1983, 3/11/1990, 3/11/1997, 3/11/2004, 3/11/2011, 3/11/2018, 3/11/2026
            YearlySchedule year = new YearlySchedule { Frequency = 7 };
            IList<DateTime> occurrences = year.GetOccurrences(_start, new DateTime(1900, 1, 1), new DateTime(1983, 11, 3)).ToList();
        ...
        public void Occurrences_crossing_start()
        {
            // 3/11/1983, 3/11/1990, 3/11/1997, 3/11/2004, 3/11/2011, 3/11/2018, 3/11/2026
            YearlySchedule year = new YearlySchedule { Frequency = 7 };
            IList<DateTime> occurrences = year.GetOccurrences(_start, new DateTime(1970, 1, 1), new DateTime(1990, 11, 3)).ToList();
        ...
        public void Occurrences_within_period()
        {
            // 3/11/1983, 3/11/1990, 3/11/1997, 3/11/2004, 3/11/2011, 3/11/2018, 3/11/2026
            YearlySchedule year = new YearlySchedule { Frequency = 7 };
            IList<DateTime> occurrences = year.GetOccurrences(_start, new DateTime(1985, 3, 1), new DateTime(2005, 1, 1)).ToList();
        ...
        public void Occurrences_stress_test()
        {
            ...
            IList<DateTime> occurrences = year.GetOccurrences(d, d, new DateTime(2899, 12, 31)).ToList();
        ...
        public void Occurrences_with_time()
        {
            // 3/11/1983, 3/11/1990, 3/11/1997, 3/11/2004, 3/11/2011, 3/11/2018, 3/11/2026
            YearlySchedule year = new YearlySchedule { Frequency = 7 };
            IList<DateTime> occurrences = year.GetOccurrences(
                new DateTime(1983, 11, 3, 18, 0, 0),
                new DateTime(2004, 11, 3, 14, 0, 0),
                new DateTime(2015, 12, 31)).ToList();
