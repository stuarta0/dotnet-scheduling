...
{
    [TestClass]
    public class MonthlyDaySchedule_Fixture
    {
        private DateTime _start;

        public MonthlyDaySchedule_Fixture()
        {
        ...
        public void Occurrences_before_start_boundry_case()
        {
            // 21/2/2009, 21/8/2010, 21/2/2012, 21/8/2013, 21/2/2015
            MonthlyDaySchedule month = new MonthlyDaySchedule { Frequency = 1 };
            IList<DateTime> occurrences = month.GetOccurrences(_start, new DateTime(2009, 1, 1), new DateTime(2010, 4, 1)).ToList();
        ...
        public void Occurrences_crossing_start()
        {
            // 21/2/2009, 21/8/2010, 21/2/2012, 21/8/2013, 21/2/2015
            MonthlyDaySchedule month = new MonthlyDaySchedule { Frequency = 1 };
            IList<DateTime> occurrences = month.GetOccurrences(_start, new DateTime(2010, 1, 1), new DateTime(2010, 6, 30)).ToList();
        ...
        public void Occurrences_within_period()
        {
            // 21/2/2009, 21/8/2010, 21/2/2012, 21/8/2013, 21/2/2015
            MonthlyDaySchedule month = new MonthlyDaySchedule { Frequency = 1 };
            IList<DateTime> occurrences = month.GetOccurrences(_start, new DateTime(2010, 12, 1), new DateTime(2011, 3, 1)).ToList();
        ...
        public void Occurrences_stress_test()
        {
            ...
            MonthlyDaySchedule month = new MonthlyDaySchedule { Frequency = 1 };
            IList<DateTime> occurrences = month.GetOccurrences(d, d, new DateTime(2999, 12, 31)).ToList();
        ...
        {
            MonthlyDaySchedule month = new MonthlyDaySchedule { Frequency = 1 };
            IList<DateTime> occurrences = month.GetOccurrences(_start.AddDays(1), new DateTime(2010, 3, 31), new DateTime(2010, 6, 30)).ToList();
        ...
        public void Occurrences_first_monday()
        {
            ...
            IList<DateTime> occurrences = month.GetOccurrences(_start.AddDays(4), new DateTime(2010, 3, 31), new DateTime(2010, 6, 30)).ToList();
        ...
        {
            MonthlyDaySchedule month = new MonthlyDaySchedule { Frequency = 1 };
            IList<DateTime> occurrences = month.GetOccurrences(_start.AddDays(7), new DateTime(2010, 3, 31), new DateTime(2010, 6, 30)).ToList();
        ...
        {
            MonthlyDaySchedule month = new MonthlyDaySchedule { Frequency = 2 };
            IList<DateTime> occurrences = month.GetOccurrences(_start.AddDays(10), new DateTime(2010, 3, 31), new DateTime(2010, 6, 30)).ToList();
        ...
        {
            MonthlyDaySchedule month = new MonthlyDaySchedule { Frequency = 1 };
            IList<DateTime> occurrences = month.GetOccurrences(_start.AddDays(16), new DateTime(2010, 3, 31), new DateTime(2010, 6, 30)).ToList();
        ...
        {
            MonthlyDaySchedule month = new MonthlyDaySchedule { Frequency = 2 };
            IList<DateTime> occurrences = month.GetOccurrences(_start.AddDays(20), new DateTime(2010, 3, 31), new DateTime(2010, 6, 30)).ToList();
        ...
        {
            MonthlyDaySchedule month = new MonthlyDaySchedule { Frequency = 1 };
            IList<DateTime> occurrences = month.GetOccurrences(_start.AddDays(22), new DateTime(2010, 3, 31), new DateTime(2010, 6, 30)).ToList();
        ...
        //    IList<DateTime> occurrences = month.GetOccurrences(_start, new DateTime(2010, 3, 31), new DateTime(2010, 6, 30).ToList();
        ...
        {
            MonthlyDaySchedule month = new MonthlyDaySchedule { Frequency = 1 };
            IList<DateTime> occurrences = month.GetOccurrences(_start.AddDays(23), new DateTime(2010, 3, 31), new DateTime(2010, 6, 30)).ToList();
        ...
        {
            MonthlyDaySchedule month = new MonthlyDaySchedule { Frequency = 2 };
            IList<DateTime> occurrences = month.GetOccurrences(_start.AddDays(26), new DateTime(2010, 3, 31), new DateTime(2010, 6, 30)).ToList();
        ...
        {
            MonthlyDaySchedule month = new MonthlyDaySchedule { Frequency = 1 };
            IList<DateTime> occurrences = month.GetOccurrences(_start.AddDays(29), new DateTime(2010, 3, 31), new DateTime(2010, 6, 30)).ToList();
        ...
        public void Occurrences_first_tuesday_with_time_component()
        {
            ...
            IList<DateTime> occurrences = month.GetOccurrences( 
                ...
                new DateTime(2011, 11, 1, 11, 0, 0)).ToList();
        ...
        public void Occurrences_first_tuesday_with_time_component_afternoon()
        {
            ...
            IList<DateTime> occurrences = month.GetOccurrences( 
                new DateTime(2011, 8, 2, 14, 30, 0),
                new DateTime(2011, 8, 17), 
                new DateTime(2011, 11, 1, 15, 0, 0)).ToList();
