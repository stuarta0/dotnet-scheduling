...
{
    [TestFixture]
    public class WeeklySchedule_Fixture : TestBase
    {
        ...
        public void Occurrences_before_start_boundry_case()
        {
            // 1/4 -> 12/4, 15/4 -> 26/4, 29/4
            WeeklySchedule week = new WeeklySchedule { Frequency = 2, Monday = true, Thursday = true };
            IList<DateTime> occurrences = Convert(week.GetOccurrences(_start, new DateTime(2010, 3, 1), new DateTime(2010, 4, 1)));
        ...
        public void Occurrences_crossing_start()
        {
            // 1/4 -> 12/4, 15/4 -> 26/4, 29/4
            WeeklySchedule week = new WeeklySchedule { Frequency = 2, Monday = true, Thursday = true };
            IList<DateTime> occurrences = Convert(week.GetOccurrences(_start, new DateTime(2010, 3, 20), new DateTime(2010, 4, 28)));
